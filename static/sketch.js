...
function cl_move(starting_coord, ending_coord){ // command line move passing start and end coordinates 
  console.log("js received move from " + starting_coord + " to " + ending_coord)
  var starting_index = get_index_from_classic_coord(starting_coord[0], starting_coord[1])
  var ending_index = get_index_from_classic_coord(ending_coord[0], ending_coord[1])
...
function mousePressed() {
  ...
  if (chessboard.hit_piece != 0){ // a piece was on hold -> release it and exit
